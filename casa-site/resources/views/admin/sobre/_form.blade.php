...
<div class="input-field">
    ...
    <input type="text" name="nome" value="{{ isset($contaPagamento->nome) ? $contaPagamento->nome : old('nome') }}" placeholder="Digite aqui o nome que está na Conta">
    @error('nome')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
...
<div class="input-field">
    ...
    <input type="text" name="cnpj" value="{{ isset($contaPagamento->cnpj) ? $contaPagamento->cnpj : old('cnpj') }}" placeholder="Digite aqui o cnpj da Conta">
    @error('cnpj')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
...
<div class="input-field">
    ...
    <input type="text" name="banco" value="{{ isset($contaPagamento->banco) ? $contaPagamento->banco : old('banco') }}" placeholder="Digite aqui o nome do banco">
    @error('bancoS')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
...
<div class="input-field">
    ...
    <input type="text" name="agencia" value="{{ isset($contaPagamento->agencia) ? $contaPagamento->agencia : old('agencia') }}" placeholder="Digite aqui o número da agência">
    @error('agencia')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
...
<div class="input-field">
    ...
    <input type="text" name="operacao" value="{{ isset($contaPagamento->operacao) ? $contaPagamento->operacao : old('operacao') }}" placeholder="Digite aqui o número da operação que corresponde a conta">
    @error('operacao')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
...
<div class="input-field">
    ...
    <input type="text" name="numero_conta" value="{{ isset($contaPagamento->numero_conta) ? $contaPagamento->numero_conta : old('numero_conta') }}" placeholder="Digite aqui o número da Conta">
    @error('numero_conta')
        <span class="invalid-feedback" role="alert">
            {{ $message }}
        </span>
